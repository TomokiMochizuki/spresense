...
#endif
    mossfw_output_t *outacc0 = geteis_errorpipeline()->lpfacc0.out[0];
    mossfw_output_t *outgyr0 = geteis_errorpipeline()->lpfgyr0.out[0];
    mossfw_output_t *outacc1 = geteis_errorpipeline()->lpfacc1.out[0];
    mossfw_output_t *outgyr1 = geteis_errorpipeline()->lpfgyr1.out[0];
